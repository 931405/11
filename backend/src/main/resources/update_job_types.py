...
summer_jobs = [
    {
        ...
        "skills": json.dumps(["Golang", "MySQL", "Redis", "高并发", "微服务"], ensure_ascii=False),
        "tags": json.dumps(["转正机会大", "大牛带队", "免费三餐", "住房补贴"], ensure_ascii=False),
    ...
    },
    {
        ...
        "skills": json.dumps(["React", "Vue3", "TypeScript", "Webpack"], ensure_ascii=False),
        "tags": json.dumps(["转正率80%", "六险一金", "弹性工作"], ensure_ascii=False),
    ...
    },
    {
        ...
        "skills": json.dumps(["产品设计", "数据分析", "Axure", "需求分析"], ensure_ascii=False),
        "tags": json.dumps(["S级项目", "导师一对一", "快速晋升"], ensure_ascii=False),
    ...
    },
    {
        ...
        "skills": json.dumps(["PyTorch", "LLM", "NLP", "深度学习"], ensure_ascii=False),
        "tags": json.dumps(["前沿技术", "海量算力", "顶薪转正"], ensure_ascii=False),
    ...
    },
    {
        ...
        "skills": json.dumps(["商业分析", "SQL", "行研报告", "数据洞察"], ensure_ascii=False),
        "tags": json.dumps(["直面高管", "深度行研", "精英圈层"], ensure_ascii=False),
...
remote_jobs = [
    {
        ...
        "skills": json.dumps(["小红书运营", "文案撰写", "内容策划", "图片排版"], ensure_ascii=False),
        "tags": json.dumps(["时间自由", "全票据报销", "无需打卡", "云端团队"], ensure_ascii=False),
    ...
    },
    {
        ...
        "skills": json.dumps(["字幕翻译", "英语专八", "本地化", "ArcTime"], ensure_ascii=False),
        "tags": json.dumps(["按件计费", "项目制", "时间灵活"], ensure_ascii=False),
    ...
    },
    {
        ...
        "skills": json.dumps(["原画设计", "二次元风格", "SAI/PS", "人物立绘"], ensure_ascii=False),
        "tags": json.dumps(["云端审稿", "接单自由", "版权署名"], ensure_ascii=False),
    ...
    },
    {
        ...
        "skills": json.dumps(["社群运营", "用户维系", "活动策划", "沟通能力"], ensure_ascii=False),
        "tags": json.dumps(["一部手机搞定", "月度奖金", "工作不设限"], ensure_ascii=False),
    ...
    },
    {
        ...
        "skills": json.dumps(["跨境电商", "Shopify", "英语读写", "竞品分析"], ensure_ascii=False),
        "tags": json.dumps(["跨境风口", "老带新", "时间灵活"], ensure_ascii=False),
...
grad_jobs = [
    {
        ...
        "skills": json.dumps(["财务管理", "各类报表", "审计支持", "CPA优先"], ensure_ascii=False),
        "tags": json.dumps(["管培生计划", "全留用指标", "年底分红制", "完善培训"], ensure_ascii=False),
    ...
    },
    {
        ...
        "skills": json.dumps(["C/C++", "Linux内核", "操作系统", "车载OS"], ensure_ascii=False),
        "tags": json.dumps(["硬核技术", "100%转正", "购车补贴", "六险二金"], ensure_ascii=False),
        "salary_min": 250, "salary_max": 400,
        "duration": "每周5天 至毕业"
    },
    {
        ...
        "skills": json.dumps(["TO B销售", "陌拜", "商务谈判", "SaaS软件"], ensure_ascii=False),
        "tags": json.dumps(["高底薪高提成", "狼性文化", "销冠带教"], ensure_ascii=False),
        "salary_min": 150, "salary_max": 200,
        "duration": "每周5天 3个月"
    },
    {
        ...
        "skills": json.dumps(["海外PR", "KOL商务", "TikTok营销", "英语流利"], ensure_ascii=False),
        "tags": json.dumps(["全球出海", "外企氛围", "直通转正"], ensure_ascii=False),
    ...
    },
    {
        ...
        "skills": json.dumps(["招聘交付", "简历筛选", "面试安排", "人才Mapping"], ensure_ascii=False),
        "tags": json.dumps(["100%留用", "团队氛围好", "扁平管理"], ensure_ascii=False),
