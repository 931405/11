...
public interface IAdminService {
    ...
    Map<String, Object> getDataIntegrationOverview();

    Page<DataIntegrationRecord> getDataIntegrationRecords(String targetType, String verificationStatus, String sourceType,
            int page, int size);

    void reviewDataIntegrationRecord(Long recordId, String status, String remark);

    Map<String, String> getDataIntegrationRules();

    void saveDataIntegrationRules(Map<String, String> rules);
}
